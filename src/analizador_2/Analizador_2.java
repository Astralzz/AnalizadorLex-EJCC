...
public class Analizador_2 {
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\1\0\1\11\1\1\2\11\2\1";
 ...
 /* Código personalizado */
     ...
     */
    public Analizador_2(java.io.Reader in) {
        ...
        while (true) {
            ...
            if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
                ...
                switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                    case 1: {
                        TokenPersonalizado t = new TokenPersonalizado("Enter", "Nueva linea");
                    ...
                    case 6:
                        break;
                    case 2: { // Ignorar cuando se ingrese un espacio
                    }
                    // fall through
                    case 7:
                        break;
                    ...
                    case 10:
                        break;
                    default:
//                        TokenPersonalizado t = new TokenPersonalizado(yytext(), "No definida");
//                        this._existenTokens = true;
//                        return t;
